...
import { signUp, signIn, signInWithGoogle } from '@/src/lib/supabase-storage';
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            {isSignUp
              ? 'Save your assessment and track progress across devices'
        ...
        {!configured && (
          <div className="mb-6 p-4 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-sm flex items-start gap-2">
            ...
            <div>
              <strong>Supabase not configured.</strong> The app works with localStorage.
              To enable accounts, add VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY to .env.local
            </div>
          </div>
        )}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 p-3 rounded-lg bg-background border border-border focus:ring-2 focus:ring-accent outline-none"
        ...
        <p className="text-xs text-center text-muted-foreground mt-4">
          Creating an account is optional. The app works fully without it.
        </p>
      </motion.div>
    </div>
  );
